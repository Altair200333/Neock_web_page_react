...
function VoxelMixer()
{
    ...
    <div style={{width:'600px'}}>
        ...
        <div className='postText'>
            While on the surface this may look similar to previous project, the internals of this programm are very different
        </div>
        <p/>
        <img src = 'post_imgs/voxel_mixer.jpg' className='exampleImg'></img>
        <p/>
        <div className='postText'>
            Scene can be rendered on CPU and GPU either in a single pass or with multiframe accumulation
            <p/>
            Skybox, HDRI background, sun power, location, color and rending sampling can be adjusted in UI<br/>
            <p/>
            ...
            and the solution i came up with is to turn tree into 1D array of floats and upload it as Texture Buffer Object 
        <p/>
